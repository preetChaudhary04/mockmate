...
const Interview = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 border-b border-white/10 bg-white/5 backdrop-blur-xl">
        <h1 className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
          MockMate
        </h1>
        <button
          onClick={handleLogout}
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-red-500/40 hover:bg-red-500/10 text-gray-300 hover:text-red-400 transition-all duration-300 text-sm cursor-pointer"
        >
          <LogOut size={16} />
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10 relative">
        ...
        {/* Background Glow */}
        <div className="absolute w-72 h-72 bg-cyan-500/20 blur-3xl rounded-full top-10 left-10 pointer-events-none"></div>
        <div className="absolute w-72 h-72 bg-purple-500/20 blur-3xl rounded-full bottom-10 right-10 pointer-events-none"></div>
